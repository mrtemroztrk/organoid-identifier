...
[![PyPI version](https://img.shields.io/badge/version-0.4.7-blue.svg)](https://test.pypi.org/project/organoid-identifier/)
...
```bash
pip install -i https://test.pypi.org/simple/ organoid-identifier==0.4.7
```
